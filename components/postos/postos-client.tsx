...
function CounterCard({
  ...
  return (
    <div className={`min-h-[112px] rounded-xl border border-gray-100 border-t-4 bg-white p-3 shadow-sm ${topColor}`}>
      <p className="text-2xl font-black tracking-tight text-gray-900">{value}</p>
      <p className="mt-1 text-xs font-semibold uppercase tracking-widest text-gray-500">{label}</p>
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
            ...
            {role === 'supervisor' && (
              <button
                ...
                className="col-span-2 flex h-9 w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-3 text-xs font-semibold text-white hover:bg-emerald-700 transition-colors sm:ml-auto sm:w-auto"
              >
                  ...
                  {COLS.map(col => (
                    <th
                      ...
                      className={[
                        ...
                        col.sortKey === sortCol ? 'text-gray-700' : 'text-gray-500',
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-500">Secretaria</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-500">Efetivo Previsto</label>
                  <input type="number" min={0} value={formPrevisto} onChange={e => setFormPrevisto(Number(e.target.value))}
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-400" />
                </div>
                <div>
                  <label className="mb-1 block text-xs font-semibold uppercase tracking-widest text-gray-500">Cota Insalubridade</label>
