...
const s = StyleSheet.create({
  page:        { padding: 32, fontSize: 7, fontFamily: 'Helvetica', backgroundColor: '#ffffff' },
  title:       { fontSize: 11, fontWeight: 'bold', marginBottom: 2 },
  subtitle:    { fontSize: 7, color: '#6b7280', marginBottom: 16 },
  ...
  td:          { fontSize: 7, color: '#374151', paddingVertical: 3, paddingHorizontal: 3 },
  tdNum:       { fontSize: 7, color: '#374151', paddingVertical: 3, paddingHorizontal: 3,
                 textAlign: 'center' },
  tdBold:      { fontSize: 7, fontWeight: 'bold', color: '#1d4ed8', paddingVertical: 3,
