...
const s = StyleSheet.create({
  ...
  cbBox:   { width: 8, height: 8, borderWidth: 1, borderColor: DARK, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  cbX:     { fontSize: 6, fontFamily: 'Helvetica-Bold', lineHeight: 1 },
